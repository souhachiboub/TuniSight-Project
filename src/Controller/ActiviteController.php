...
final class ActiviteController extends AbstractController
{
    ...
    public function newActivite(Request $request, EntityManagerInterface $entityManager, SessionInterface $session, Security $security): Response
    {
        ...
        if (!$user) {
            throw $this->createAccessDeniedException('Vous devez être connecté pour ajouter une activité.');
        }
    ...
    public function showActivteFrontOffice(Activite $activite, SessionInterface $session): Response
    {
    ...
    #[Route('/back/{id}', name: 'app_activite_showBack', methods: ['GET'])]
    public function showActiviteBackOffice(Activite $activite): Response
    {
        return $this->render('BackOffice-activites/show.html.twig', [
            'activite' => $activite,
        ]);
    }
