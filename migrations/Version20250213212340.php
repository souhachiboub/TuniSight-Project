 ...
 */
final class Version20250213212340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, categorie_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, duree INT DEFAULT NULL, localisation VARCHAR(255) NOT NULL, capacite INT NOT NULL, disponibilite TINYINT(1) NOT NULL, INDEX IDX_B8755515A76ED395 (user_id), INDEX IDX_B8755515BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pack (id INT AUTO_INCREMENT NOT NULL, offre_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, reduction_total DOUBLE PRECISION NOT NULL, INDEX IDX_97DE5E234CC8505A (offre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pack_produit (pack_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_12EC7C5A1919B217 (pack_id), INDEX IDX_12EC7C5AF347EFB (produit_id), PRIMARY KEY(pack_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, demande_prestataire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, num_tel INT NOT NULL, cin INT DEFAULT NULL, email VARCHAR(255) NOT NULL, carte_pro VARCHAR(255) DEFAULT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) DEFAULT NULL, photo_profil VARCHAR(255) DEFAULT NULL, bio VARCHAR(255) DEFAULT NULL, role VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64975EC866A (demande_prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pack ADD CONSTRAINT FK_97DE5E234CC8505A FOREIGN KEY (offre_id) REFERENCES offre (id)');
        $this->addSql('ALTER TABLE pack_produit ADD CONSTRAINT FK_12EC7C5A1919B217 FOREIGN KEY (pack_id) REFERENCES pack (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pack_produit ADD CONSTRAINT FK_12EC7C5AF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pack DROP FOREIGN KEY FK_97DE5E234CC8505A');
        $this->addSql('ALTER TABLE pack_produit DROP FOREIGN KEY FK_12EC7C5A1919B217');
        $this->addSql('ALTER TABLE pack_produit DROP FOREIGN KEY FK_12EC7C5AF347EFB');
        ...
        $this->addSql('DROP TABLE pack_produit');
