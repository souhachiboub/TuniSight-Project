 ...
 */
final class Version20250205133456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD user_id INT NOT NULL, ADD publication_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP user_id, DROP publication_id');
    }
}
