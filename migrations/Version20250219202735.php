 ...
 */
final class Version20250219202735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, categorie_id INT NOT NULL, offre_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, duree INT DEFAULT NULL, localisation VARCHAR(255) NOT NULL, capacite INT NOT NULL, disponibilite TINYINT(1) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B8755515A76ED395 (user_id), INDEX IDX_B8755515BCF5E72D (categorie_id), INDEX IDX_B87555154CC8505A (offre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, activitie_id INT NOT NULL, reduction INT NOT NULL, date_debut DATE NOT NULL, date_expiration DATE NOT NULL, INDEX IDX_AF86866FEB0ED4F5 (activitie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, categorie_produit_id INT NOT NULL, nbr_produits_id INT DEFAULT NULL, ligne_commande_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, quantite INT NOT NULL, disponibilite TINYINT(1) NOT NULL, reference VARCHAR(255) NOT NULL, INDEX IDX_29A5EC27A76ED395 (user_id), INDEX IDX_29A5EC2791FDB457 (categorie_produit_id), INDEX IDX_29A5EC2727FC0A64 (nbr_produits_id), INDEX IDX_29A5EC27E10FEE63 (ligne_commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, voucher_id INT DEFAULT NULL, demande_prestataire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, num_tel INT NOT NULL, cin INT DEFAULT NULL, email VARCHAR(255) NOT NULL, motdepasse VARCHAR(255) NOT NULL, carte_pro VARCHAR(255) DEFAULT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) DEFAULT NULL, photo_profil VARCHAR(255) DEFAULT NULL, bio VARCHAR(255) DEFAULT NULL, role VARCHAR(255) NOT NULL, confirmpwd VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64928AA1B6F (voucher_id), UNIQUE INDEX UNIQ_8D93D64975EC866A (demande_prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voucher (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, code_voucher VARCHAR(255) NOT NULL, date_emission DATE NOT NULL, date_expiration DATE NOT NULL, valeur_reduction INT NOT NULL, is_used TINYINT(1) DEFAULT NULL, INDEX IDX_1392A5D8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
