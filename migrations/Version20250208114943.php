 ...
 */
final class Version20250208114943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voucher (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, code_voucher VARCHAR(255) NOT NULL, date_emission DATE NOT NULL, date_expiration DATE NOT NULL, valeur_reduction VARCHAR(255) NOT NULL, is_used TINYINT(1) DEFAULT NULL, INDEX IDX_1392A5D8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
